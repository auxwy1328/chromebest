...
images: ["/images/tips/chrome-update-failed/cover.jpg"]
og_image: "/images/tips/chrome-update-failed/og.jpg"
faq:
...
![chrome://settings/help 页面显示版本号和更新状态](/images/tips/chrome-update-failed/cover.jpg)

![chrome://version 页面显示 Chrome 详细版本信息和可执行文件路径](/images/tips/chrome-update-failed/chrome-version.jpg)
...
![火绒安全软件拦截日志页面，显示被拦截的 GoogleUpdate.exe 记录](/images/tips/chrome-update-failed/antivirus-block.jpg)
...
![注册表编辑器中 Chrome Update 相关键值](/images/tips/chrome-update-failed/registry-editor.jpg)
...
![chrome://components 页面显示各组件状态](/images/tips/chrome-update-failed/components-status.jpg)
...
![chrome://policy 页面显示当前生效的组策略](/images/tips/chrome-update-failed/chrome-policy.jpg)
...
![Windows 服务管理器中 BITS 服务状态](/images/tips/chrome-update-failed/bits-service.jpg)
...
![Chrome 关于页面显示具体错误代码的界面](/images/tips/chrome-update-failed/error-code.jpg)
...
Chrome 更新失败虽然看起来复杂，但本质上就是网络、权限、文件完整性这三个大类的问题。先用本文开头的诊断流程定位大类，再对应具体原因的修复方法操作，绝大部分情况都能解决。
